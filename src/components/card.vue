...
export default {
  ...
  data() {
    ...
    getNext() {
      ++this.c;
      let p;
      if (this.nt <= 50) p = 0.02;
      else if (this.nt <= 60) p = 0.02 + (this.nt - 50) * 0.02;
      else if (this.nt <= 70) p = 0.22 + (this.nt - 60) * 0.03;
      else p = 0.52 + (this.nt - 70) * 0.05;
      if (Math.random() < p) {
        ++this.ct;
        this.nt = 0;
        this.nd = 0;
