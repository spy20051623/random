...
export default {
  ...
  data() {
    return {
      ...
      p: [0, 0, 0, 0, 0],
      p1: [0, 0, 0, 0, 0],
      countProbability: [1, 3, 6, 30, 60],
      probability: [8, 12, 12, 12, 4, 4, 12, 12, 12, 12, 12, 12],
      w1: [50, 25, 20, 10, 5],
      w2: [50, 500, 5000, 10000, 5000],
    ...
    getCount() {
      ...
      if (num === 3 && this.jy1 === 2 || num === 4 && this.jy1 === 5 || x <= 1) {
        this.get(id);
        this.jy1 = 0;
        ++this.jy2;
      }
